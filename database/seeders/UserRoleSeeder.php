...
class UserRoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $admin = User::firstOrCreate(
            ['email' => 'pradnyanirmala12@gmail.com'], // Pastikan email tidak berubah
            [
                'name' => 'admin',
...
if (!$admin->hasRole('admin')) {
    $admin->assignRole('admin');
        ...
        $user = User::firstOrCreate(
            ['email' => 'senopati24@gmail.com'], // Pastikan email tidak berubah
            [
                'name' => 'Senopati',
                'password' => bcrypt('kaivann24'), // Ganti dengan password yang lebih aman
            ]
        );
