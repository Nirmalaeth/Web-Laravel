...
<div class="relative group">
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="max-w-6xl mx-auto">
            <h1 class="text-4xl font-bold text-[#B09076] mb-8 fade-in"><?php echo e($category); ?></h1>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group relative bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105">
                        <img src="<?php echo e(asset($product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-64 object-cover transition-opacity duration-500 opacity-90 group-hover:opacity-100">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 bg-[#FFF7E6] bg-opacity-90 py-4 px-6">
                            <p class="text-[#D17B88] text-lg font-semibold"><?php echo e($product->name); ?></p>
                            <p class="text-[#D17B88] text-lg font-semibold">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                            <p class="text-[#D17B88] text-sm"><?php echo e($product->description); ?></p>
                            <?php if($product->stock > 0): ?>
                                <p class="text-green-600 text-sm mt-2">In Stock (<?php echo e($product->stock); ?>)</p>
                            <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\nir_bakery\resources\views/shop/category.blade.php ENDPATH**/ ?>