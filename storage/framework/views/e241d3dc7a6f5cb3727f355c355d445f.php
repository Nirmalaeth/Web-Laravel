...
<div class="relative group">
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="max-w-6xl mx-auto">
            <h1 class="text-4xl font-bold text-[#B09076] mb-8 fade-in">Beverages</h1>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group relative bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105">
                    <img src="/images/americano.jpg" alt="Americano" class="w-full h-64 object-cover transition-opacity duration-500 opacity-90 group-hover:opacity-100">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-[#FFF7E6] bg-opacity-90 py-4 px-6">
                        <p class="text-[#D17B88] text-lg font-semibold">Americano</p>
                        <p class="text-[#D17B88] text-lg font-semibold">Rp 20.000</p>
                </div>
            </div>
                <!-- Card 2 -->
                <div class="group relative bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105">
                    <img src="/images/caramel.jpg" alt="Caramel Macchiato" class="w-full h-64 object-cover transition-opacity duration-500 opacity-90 group-hover:opacity-100">
                    <div class="absolute inset-0 bg-black bg-opacity-25 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    <div class="absolute bottom-0 left-0 right-0 bg-[#FFF7E6] bg-opacity-90 py-4 px-6">
                        <p class="text-[#D17B88] text-lg font-semibold">Caramel Macchiato</p>
                        <p class="text-[#D17B88] text-lg font-semibold">Rp 23.000</p>
                </div>
            </div>
                <!-- Card 3 -->
                <div class="group relative bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105">
                    <img src="/images/esteh.jpg" alt="Iced Tea" class="w-full h-64 object-cover transition-opacity duration-500 opacity-90 group-hover:opacity-100">
                    <div class="absolute inset-0 bg-black bg-opacity-25 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    <div class="absolute bottom-0 left-0 right-0 bg-[#FFF7E6] bg-opacity-90 py-4 px-6">
                        <p class="text-[#D17B88] text-lg font-semibold">Iced Tea</p>
                        <p class="text-[#D17B88] text-lg font-semibold">Rp 10.000</p>
                </div>
            </div>
                <!-- Card 4 -->
                <div class="group relative bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105">
                    <img src="/images/water.jpg" alt="Mineral Water" class="w-full h-64 object-cover transition-opacity duration-500 opacity-90 group-hover:opacity-100">
                    <div class="absolute inset-0 bg-black bg-opacity-25 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    <div class="absolute bottom-0 left-0 right-0 bg-[#FFF7E6] bg-opacity-90 py-4 px-6">
                        <p class="text-[#D17B88] text-lg font-semibold">Mineral Water</p>
                        <p class="text-[#D17B88] text-lg font-semibold">Rp 7.000</p>
                </div>
            </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\nir_bakery\resources\views/shop/beverages.blade.php ENDPATH**/ ?>